...
class api1 extends StatefulWidget {
  ...
  @override
  State<api1> createState() => apiPage();
}

class apiPage extends State<api1> {
  String apiUrl = 'https://632017e19f82827dcf24a655.mockapi.io/api/programs';
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: AssetImage('assets/listening_music.png'),)),
                      ),
                      Padding(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Spacer(),
                                Icon(listResponse[0]['locked'] != null ? (listResponse[0]['locked'].toString() == "null" ? Icons.lock_open : Icons.lock_outline) : null),
                              ],
                            ),
                          ],
                        ),
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Spacer(),
                                Icon(listResponse[1]['locked'] != null ? (listResponse[1]['locked'].toString() == "null" ? Icons.lock_open : Icons.lock_outline) : null),
                              ],
                            ),
                          ],
                        ),
